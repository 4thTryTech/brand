...
- The logo is the roundel in `logo/`; `logo/lockup-*` pairs it with the wordmark. Landscape hero art is in `hero/`. The splash art in `splash/` is hero artwork, not a logo.
